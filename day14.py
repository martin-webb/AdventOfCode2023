...
def part2_cycle_detection(input: str) -> int:
    rows = tuple([line for line in input.split("\n") if line != ""])
    cols = transpose(rows)
...
def main() -> None:
    for (label, filename, func, expected) in (
        ...
        ("Part 2/Naive", "inputs/day14_example.txt", part2, 64),
        ("Part 2/Naive", "inputs/day14_full.txt", part2, 106689),
        ("Part 2/CycleDetection", "inputs/day14_example.txt", part2_cycle_detection, 64),  # noqa: [E501]
        ("Part 2/CycleDetection", "inputs/day14_full.txt", part2_cycle_detection, 106689),  # noqa: [E501]
    ):
